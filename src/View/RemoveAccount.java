...
public class RemoveAccount extends javax.swing.JFrame {
    ...
    public RemoveAccount(MessengerInterface manager) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Number Account");
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        ...
        try {
            if(manager.removeAccount(numberAccount)){
                JOptionPane.showMessageDialog(null, "Account remove success"); 
                this.dispose();
            }else{
                JOptionPane.showMessageDialog(null, "Not Already exists number account"); 
                this.dispose();
            }
